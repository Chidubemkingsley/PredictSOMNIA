/**
 * Create Additional Markets on Somnia Shannon Testnet
...
const PREDICTION_MARKET_ADDRESS = process.env.PREDICTION_MARKET_ADDRESS || process.env.NEXT_PUBLIC_PREDICTION_MARKET_ADDRESS || '0x67F7B580AEd6de246f7db70e19efdcE4Dd34Fc61'; // Somnia Shannon primary PM2
...
async function main() {
  try {
    console.log('═════════════════════════════════════════════════════════════');
    console.log('📝 CREATE ADDITIONAL MARKETS ON Somnia TESTNET');
    console.log('═════════════════════════════════════════════════════════════');
    console.log('');
    ...
    // Connect to Somnia Shannon Testnet (STT, tUSDC 6d)
    ...
    console.log('  node scripts/test-somnia-live-markets.js');
    console.log('');

...
- **npm**: >= 9.0.0
- **Git**: Latest version
- **Somnia Shannon Testnet Faucet**: Get test STT from https://shannon-explorer.somnia.network
...
Your contributions make PredictSOMNIA better for everyone. We appreciate your time and effort!
